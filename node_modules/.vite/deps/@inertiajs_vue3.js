...
var x = L;
function P(e, o) {
  let n = typeof e == "string" ? e : null, l = typeof e == "object" ? e : o, t = n ? Je.restore(n) : null, p = (0, import_lodash2.default)(l), a = null, m = null, d = (r) => r, h2 = reactive({ ...t ? t.data : l, isDirty: false, errors: t ? t.errors : {}, hasErrors: false, processing: false, progress: null, wasSuccessful: false, recentlySuccessful: false, data() {
    ...
    r === "delete" ? Je.delete(i, { ...g, data: f }) : Je[r](i, f, g);
  }, get(r, i) {
    this.submit("get", r, i);
  }, post(r, i) {
  ...
  return watch(h2, (r) => {
    h2.isDirty = !(0, import_lodash3.default)(h2.data(), p), n && Je.remember((0, import_lodash2.default)(r.__remember()), n);
...
var N = defineComponent({ name: "Inertia", props: { initialPage: { type: Object, required: true }, initialComponent: { type: Object, required: false }, resolveComponent: { type: Function, required: false }, titleCallback: { type: Function, required: false, default: (e) => e }, onHeadUpdate: { type: Function, required: false, default: () => () => {
  ...
  return k = Y(p, l, t), p || (Je.init({ initialPage: e, resolveComponent: n, swapComponent: async (a) => {
    c.value = markRaw(a.component), b.value = a.page, T.value = a.preserveState ? T.value : Date.now();
  } }), Je.on("navigate", () => k.forceUpdate())), () => {
    if (c.value) {
...
var $ = N;
var E = { install(e) {
  Je.form = P, Object.defineProperty(e.config.globalProperties, "$inertia", { get: () => Je }), Object.defineProperty(e.config.globalProperties, "$page", { get: () => b.value }), Object.defineProperty(e.config.globalProperties, "$headManager", { get: () => k }), e.mixin(x);
} };
function J() {
  return b.value;
}
async function I({ id: e = "app", resolve: o, setup: n, title: l, progress: t = {}, page: p, render: a }) {
  let m = typeof window > "u", d = m ? null : document.getElementById(e), h2 = p || JSON.parse(d.dataset.page), r = (f) => Promise.resolve(o(f)).then((g) => g.default || g), i = [], s = await r(h2.component).then((f) => n({ el: d, App: $, props: { initialPage: h2, initialComponent: f, resolveComponent: r, titleCallback: l, onHeadUpdate: m ? (g) => i = g : null }, plugin: E }));
  if (!m && t && ee(t), m) {
