...
var N = class {
  ...
  visit(e, { method: r = "get", data: i = {}, replace: s = false, preserveScroll: n = false, preserveState: u = false, only: f = [], headers: b = {}, errorBag: l = "", forceFormData: c = false, onCancelToken: v = () => {
  }, onBefore: R = () => {
  }, onStart: d = () => {
  }, onProgress: p = () => {
  }, onFinish: V = () => {
    ...
    this.activeVisit = { ...S, onCancelToken: v, onBefore: R, onStart: d, onProgress: p, onFinish: V, onCancel: y, onSuccess: D, onError: U, queryStringArrayFormat: I, cancelToken: new AbortController() }, v({ cancel: () => {
      this.activeVisit && this.cancelVisit(this.activeVisit, { cancelled: true });
      ...
      let E = P, G = g(a.url);
      return E.hash && !G.hash && x(E).href === G.href && (G.hash = E.hash, a.url = G.href), this.setPage(a, { visitId: M, replace: s, preserveScroll: n, preserveState: u });
    }).then(() => {
      ...
      if (this.isLocationVisitResponse(o.response)) {
        let a = g(o.response.headers["x-inertia-location"]), E = P;
...
function Y(t, e, r) {
  ...
  function b() {
    let c = e(""), v = { ...c ? { title: `<title inertia="">${c}</title>` } : {} }, R = Object.values(i).reduce((d, p) => d.concat(p), []).reduce((d, p) => {
      if (p.indexOf("<") === -1)
        return d;
...
nprogress/nprogress.js:
   ...
   * @license MIT *)
*/
//# sourceMappingURL=chunk-VF3FLZ5A.js.map
